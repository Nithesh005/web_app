    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1 bg-white p-8 flex">
        <div className="flex flex-col justify-center items-center w-full gap-8">
          ...
          <div><TextField id="outlined-basic" label="Name" variant="outlined" sx={{width:'350px'}} /></div>
          <div><TextField id="outlined-basic" label="Password" type="password" variant="outlined" sx={{width:'350px'}} /></div>
          <div><TextField id="outlined-basic" label="Marriage Date"  variant="outlined" sx={{width:'350px'}} /></div>
